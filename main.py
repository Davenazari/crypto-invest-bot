    ...
    try:
        with psycopg2.connect(DATABASE_URL) as conn:
            with conn.cursor() as c:
                ...
                # تعریف جدول lands (جایگزین seeds)
                ...
                # تعریف جدول user_lands (جایگزین user_seeds)
                ...
                # مهاجرت داده‌ها از جداول قدیمی seeds و user_seeds
                ...
                if seeds_table_exists:
                    # مهاجرت داده‌های جدول seeds به lands
                    ...
                    # مهاجرت داده‌های جدول user_seeds به user_lands
                    ...
                    # آپدیت land_id در جدول transactions
                    ...
                    # حذف ستون seed_id از جدول profits (اختیاری)
                    ...
                    # حذف جداول قدیمی (اختیاری، با احتیاط)
                ...
                # پر کردن یا به‌روزرسانی جدول lands
                ...
                # چک کردن وجود ستون land_id در جدول transactions
