...
messages = {
    "fa": {
        "welcome": (
            "🌟 *خوش اومدید به مزرعه USDT!* 🏞️\n"
            "اینجا می‌تونید زمین بخرید، هر روز بکارید و سود تضمین‌شده برداشت کنید. "
        ...
        "wallet_balance": lambda balance, seeds, total_profit, transaction_count, last_transaction: (
            ...
            f"🎁 **بونوس**: `0.0` تتر\n"
            f"💎 **$FMX**: `0.0`\n"
            f"🏞️ **زمین‌های شما**: {seeds or 'هیچ زمینی ندارید'}\n"
        ...
        "harvest_not_ready": (
            "⚠️ *خطا*: هنوز نمی‌تونید سود این زمین‌ها رو برداشت کنید!\n"
    ...
    "en": {
        ...
        "wallet": lambda network, address: (
            ...
            f"Please send your deposit to this address:\n"
            f"📋 `{address}`\n"
        ...
        "wallet_balance": lambda balance, seeds, total_profit, transaction_count, last_transaction: (
            ...
            f"🎁 **Bonus**: `0.0` USDT\n"
            f"💎 **$FMX**: `0.0`\n"
            f"🏞️ **Your Lands**: {seeds or 'No lands yet'}\n"
        ...
        "plant_already_done": (
            "⚠️ *Error*: These lands have already been planted today!\n"
        ...
        "harvest_not_ready": (
            "⚠️ *Error*: You can't harvest these lands yet!\n"
